MAX_MODEL_TOKENS = 1024  # new constant for maximum model tokens
...
def get_qc_prompt(text):
    ...
    report_prompt = (
        ...
        "  \"dp\": \"string\", // Distribution Point.\n"
        "  \"total_defects\": \"integer\", // The total number of defects found. If not a valid integer, use null.\n"
        "  \"size_calibre\": \"integer\", // The size or calibre of the product. If not a valid integer, use null.\n"
        "  \"lot_number\": \"string\", // The lot number of the product.\n"
        "  \"inspector\": \"string\", // The name of the inspector.\n"
        "  \"estimated_yield\": \"string\", // The estimated yield of the product.\n"
